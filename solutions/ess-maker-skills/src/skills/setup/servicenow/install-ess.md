...
The base Employee Self Service agent is installed and verified. Next, we'll
capture your ServiceNow connection basics (skill 3).

**End message.**

S2.1 is now recorded in the checklist. Stop here — capturing your ServiceNow
connection basics is a separate skill.
