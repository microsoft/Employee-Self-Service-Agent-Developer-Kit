...
Infer `test` or `preprod` when the supplied URL explicitly identifies that ring. Whenever the current request and supplied target do not identify a ring, render this exact decision surface:
