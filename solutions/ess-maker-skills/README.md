...
| `/review` | Review local topics before deployment |
| `/evaluate` | Generate evaluation test sets locally |
...
| `/backup-template-configs` | Report that the retired Dataverse command is no longer supported |
| `/restore-template-configs` | Report that the retired Dataverse command is no longer supported |
