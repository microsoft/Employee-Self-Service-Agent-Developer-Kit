...
`schema_version: 4`, or that canonical agent entry does not have foundation
steps `SETUP-01`, `SETUP-02.1`, `SETUP-03`, `SETUP-04`, and `SETUP-07` in
`done` state, show the message below and STOP. Do not require aggregate `connect_ready`;
capacity and the product connection itself may still need attention.
