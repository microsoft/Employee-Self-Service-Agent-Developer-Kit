...
nav_order: 5
---
# ESS Workday Scenarios — Declarative Agent (DA)
...
> Looking for the Custom Engine Agent variant? See [../WorkdayCustomEngineAgent/](../WorkdayCustomEngineAgent/).

## Folder layout

| Folder | Description |
|---|---|
| [Employee/](./Employee/) | Self-service scenarios for the requesting employee (vacation balance, time-off requests, profile, contact info, education, government IDs, dependents, emergency contacts, peer feedback, etc.). |
| [Manager/](./Manager/) | Scenarios for managers acting on their direct reports (company code, cost center, job taxonomy, service anniversary, time in position). |
...
The DA variant covers the same employee and manager scenarios as the CEA variant. For the consolidated scenario list and sample prompts, see the table in [../WorkdayCustomEngineAgent/README.md](../WorkdayCustomEngineAgent/README.md#scenarios).
