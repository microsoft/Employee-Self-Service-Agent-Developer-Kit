...
- **Authentication** — Entra ID configuration and Conditional Access.
- **External systems** — Workday, ServiceNow, SAP integrations.
- **Workday deep checks** — 17 SOAP workflow tests against the live API.
- **Agent files** — instructions, prompts, required topics.
