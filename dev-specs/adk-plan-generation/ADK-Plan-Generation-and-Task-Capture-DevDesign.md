...
- **`src/skills/planner/SKILL.md`** — the playbook, with sub‑files: `research.md` (the Learn crawl, §7), `interview.md` (§8), `model.md` (the Plan schema + writer rules, §9), `assign.md` (Flow 1, §10), `evaluate.md` (the theoretical scenario‑eval hand‑off, §10.2), `mytasks.md` (Flow 2, §11), and `capture.md` (§12).
